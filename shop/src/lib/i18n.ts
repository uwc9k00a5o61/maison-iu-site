...
const en: Dict = {
  ...
  // account / auth
  "account.eyebrow": "Private client",
  "account.title": "Account",
  "account.login.lead":
    "Sign in to view your enquiries and VIP status. An account is optional — you can always order as a guest.",
  "account.login.emailLabel": "Email",
  "account.login.emailPlaceholder": "you@example.com",
  "account.login.sendCode": "Email me a code",
  "account.login.codeLabel": "6-digit code",
  "account.login.codeHint": "We sent a 6-digit code to {email}.",
  "account.login.verify": "Sign in",
  "account.login.back": "Use a different email",
  "account.login.resend": "Resend code",
  "account.login.sending": "Sending…",
  "account.login.verifying": "Signing in…",
  "account.login.devCode": "Dev mode — your code is {code}",
  "account.login.or": "or",
  "account.login.telegram": "Continue with Telegram",
  "account.login.telegramSoon": "Telegram sign-in coming soon",
  "account.login.errEmail": "Enter a valid email.",
  "account.login.errCode": "That code is wrong or expired. Try again.",
  "account.login.errGeneric": "Something went wrong. Please try again.",
  "account.guestNote": "Prefer not to sign in? Continue as a guest — checkout works without an account.",
  "account.dash.greeting": "Welcome back",
  "account.dash.email": "Email",
  "account.dash.logout": "Sign out",
  "account.dash.vipStatus": "VIP status",
  "account.vip.none": "No VIP tier yet",
  "account.vip.member": "VIP · {pct}% private discount",
  "account.vip.spendNote": "Cumulative confirmed spend: {amount}",
  "account.vip.noneNote": "VIP tiers unlock from $250,000 in confirmed orders.",
...
const ru: Dict = {
  ...
  "account.login.lead":
    "Войдите, чтобы видеть свои заявки и VIP-статус. Аккаунт необязателен — вы всегда можете оформить заказ как гость.",
  "account.login.emailLabel": "E-mail",
  "account.login.emailPlaceholder": "you@example.com",
  "account.login.sendCode": "Прислать код на почту",
  "account.login.codeLabel": "6-значный код",
  "account.login.codeHint": "Мы отправили 6-значный код на {email}.",
  "account.login.verify": "Войти",
  "account.login.back": "Другой e-mail",
  "account.login.resend": "Отправить код повторно",
  "account.login.sending": "Отправляем…",
  "account.login.verifying": "Входим…",
  "account.login.devCode": "DEV-режим — ваш код: {code}",
  "account.login.or": "или",
  "account.login.telegram": "Войти через Telegram",
  "account.login.telegramSoon": "Вход через Telegram скоро",
  "account.login.errEmail": "Введите корректный e-mail.",
  "account.login.errCode": "Код неверный или истёк. Попробуйте ещё раз.",
  "account.login.errGeneric": "Что-то пошло не так. Попробуйте снова.",
  "account.guestNote": "Не хотите входить? Продолжите как гость — оформление работает без аккаунта.",
  "account.dash.greeting": "С возвращением",
  "account.dash.email": "E-mail",
  "account.dash.logout": "Выйти",
  "account.dash.vipStatus": "VIP-статус",
  "account.vip.none": "VIP-уровня пока нет",
  "account.vip.member": "VIP · приватная скидка {pct}%",
  "account.vip.spendNote": "Накопленная сумма подтверждённых заказов: {amount}",
  "account.vip.noneNote": "VIP-уровни открываются от $250 000 подтверждённых заказов.",
