        ...
        <div className="mx-auto max-w-[1280px] px-5 py-10 sm:px-8 sm:py-14">
          ...
          <div className="mt-6 grid gap-8 md:grid-cols-2 md:gap-14">
            ...
            <div className="flex flex-col justify-center">
              ...
              <span className="tabular mt-3 text-[13px] tracking-[0.05em] text-ash">
                Reference {product.reference}
              </span>

              <div className="mt-6 flex items-center gap-4">
                <span className="tabular font-serif text-[26px] text-ink">
              ...
              <p className="mt-8 max-w-[46ch] text-[14px] leading-relaxed text-ash">
                Verified provenance with full box &amp; papers. Private viewing
                by appointment in Moscow, Dubai or Istanbul.
              </p>
            </div>
          </div>
        </div>
